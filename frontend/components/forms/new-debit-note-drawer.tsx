...
interface NewDebitNoteDrawerProps {
  open: boolean;
...
export function NewDebitNoteDrawer({ open, onOpenChange, onCreated }: NewDebitNoteDrawerProps) {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      toast.error(e instanceof Error ? e.message : "Error al crear nota de débito");
    } finally {
      setSubmitting(false);
    }
  }
      ...
      >
        <SheetHeader className="px-6 py-4 border-b shrink-0">
          <div className="flex items-center justify-between">
            <div>
              <SheetTitle className="text-base font-semibold">Nueva nota de débito</SheetTitle>
